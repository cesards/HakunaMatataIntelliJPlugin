...
import static postfix.util.ImportUtils.hasImportStatic;
 ...
 * @author Bob Browning
 */
public class AndroidPostfixUtil {


    public static final Condition<PsiElement> IS_NON_NULL = new Condition<PsiElement>() {
        @Override
        public boolean value(PsiElement element) {
            return IS_NON_VOID.value(element) && !AndroidPostfixUtil.isAnnotatedNullable(element);
        }
    };
    /**
